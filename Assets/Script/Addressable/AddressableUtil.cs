...
namespace Addressable
{
    ...
    {
        internal  async Task<AsyncOperationHandle<IResourceLocator>> LoadCatalog(string serverPath)
        {
        ...
        internal void ReleaseCatalog(AsyncOperationHandle<IResourceLocator> locatorHandle)
        {
        ...
        internal async Task UpdateCatalogs()
        {
        ...
        internal void SafeRelease<T>(AsyncOperationHandle<T> handle)
        {
        ...
        internal async Task<bool> AddressableExists(string key)
        {
        ...
        internal async Task<AsyncOperationHandle<T>> GetTAsync<T>(string itemPath)
        {
        ...
        internal async Task<AsyncOperationHandle<IList<T>>> GetTsAsync<T>(Addressables.MergeMode mergeMode, params string[] labels)
        {
        ...
        internal async Task<AsyncOperationHandle<T>> LoadAddressableAsset<T>(string key)
        {
